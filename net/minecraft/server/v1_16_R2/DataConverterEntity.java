...
/*     */   static {
/*  18 */     a = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), var0 -> {
...
/*  98 */     TaggedChoice.TaggedChoiceType<String> var0 = getInputSchema().findChoiceType(DataConverterTypes.ENTITY);
/*  99 */     TaggedChoice.TaggedChoiceType<String> var1 = getOutputSchema().findChoiceType(DataConverterTypes.ENTITY);
/*     */     
/* 101 */     Type<?> var2 = getInputSchema().getType(DataConverterTypes.ITEM_STACK);
/* 102 */     Type<?> var3 = getOutputSchema().getType(DataConverterTypes.ITEM_STACK);
/*     */     
/* 104 */     return TypeRewriteRule.seq(
/* 105 */         convertUnchecked("item stack entity name hook converter", var2, var3), 
/* 106 */         fixTypeEverywhere("EntityIdFix", (Type)var0, (Type)var1, var0 -> ()));
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\net\minecraft\server\v1_16_R2\DataConverterEntity.class
