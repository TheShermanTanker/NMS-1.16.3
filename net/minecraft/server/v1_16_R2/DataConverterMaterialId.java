...
/*     */   extends DataFix
/*     */ {
/*     */   public static final Int2ObjectMap<String> ID_MAPPING;
/*     */   
/*     */   public DataConverterMaterialId(Schema var0, boolean var1) {
/*  22 */     super(var0, var1);
/*     */   }
/*     */   static {
/*  25 */     ID_MAPPING = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
...
/* 345 */     return (String)ID_MAPPING.get(var0);
/*     */   }
/*     */ 
/*     */   
/*     */   public TypeRewriteRule makeRule() {
/* 350 */     Type<Either<Integer, Pair<String, String>>> var0 = DSL.or(DSL.intType(), DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.a()));
/* 351 */     Type<Pair<String, String>> var1 = DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.a());
/* 352 */     OpticFinder<Either<Integer, Pair<String, String>>> var2 = DSL.fieldFinder("id", var0);
/* 353 */     return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(DataConverterTypes.ITEM_STACK), getOutputSchema().getType(DataConverterTypes.ITEM_STACK), var2 -> var2.update(var0, var1, ()));
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\net\minecraft\server\v1_16_R2\DataConverterMaterialId.class
