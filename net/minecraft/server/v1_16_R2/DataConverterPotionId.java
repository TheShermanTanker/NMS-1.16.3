...
/*     */   
/*     */   static {
/*  27 */     a = (String[])DataFixUtils.make(new String[128], var0 -> {
...
/* 162 */     Type<?> var0 = getInputSchema().getType(DataConverterTypes.ITEM_STACK);
/* 163 */     OpticFinder<Pair<String, String>> var1 = DSL.fieldFinder("id", DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.a()));
/* 164 */     OpticFinder<?> var2 = var0.findField("tag");
/*     */     
/* 166 */     return fixTypeEverywhereTyped("ItemPotionFix", var0, var2 -> {
...
/*     */             Optional<? extends Typed<?>> var5 = var2.getOptionalTyped(var1);
...
/*     */               if (!var9.isPresent()) {
/*     */                 String var10 = a[var6 & 0x7F];
/*     */                 Typed<?> var11 = ((Typed)var5.get()).set(DSL.remainderFinder(), var8.set("Potion", var8.createString((var10 == null) ? "minecraft:water" : var10)));
/*     */                 var7 = var7.set(var1, var11);
/*     */                 if ((var6 & 0x4000) == 16384)
/*     */                   var7 = var7.set(var0, Pair.of(DataConverterTypes.ITEM_NAME.typeName(), "minecraft:splash_potion")); 
/*     */               } 
/*     */               if (var6 != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\net\minecraft\server\v1_16_R2\DataConverterPotionId.class
