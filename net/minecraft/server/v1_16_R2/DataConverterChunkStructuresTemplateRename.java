...
/* 110 */     Type<?> var0 = getInputSchema().getType(DataConverterTypes.STRUCTURE_FEATURE);
/* 111 */     OpticFinder<?> var1 = var0.findField("Children");
/* 112 */     return fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", var0, var1 -> var1.updateTyped(var0, ()));
/*     */   }
/*     */   
/*     */   private Dynamic<?> a(Dynamic<?> var0, Dynamic<?> var1) {
/* 116 */     String var2 = var0.get("id").asString("");
/* 117 */     if (a.containsKey(var2)) {
/* 118 */       Pair<String, ImmutableMap<String, String>> var3 = (Pair<String, ImmutableMap<String, String>>)a.get(var2);
/* 119 */       if (((String)var3.getFirst()).equals(var1.get("id").asString(""))) {
/* 120 */         String var4 = var1.get("Template").asString("");
/* 121 */         var1 = var1.set("Template", var1.createString((String)((ImmutableMap)var3.getSecond()).getOrDefault(var4, var4)));
/*     */       } 
/*     */     } 
/* 124 */     return var1;
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\net\minecraft\server\v1_16_R2\DataConverterChunkStructuresTemplateRename.class
