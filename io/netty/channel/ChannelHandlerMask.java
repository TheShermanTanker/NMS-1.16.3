...
/* 169 */     return ((Boolean)AccessController.<Boolean>doPrivileged(new PrivilegedExceptionAction<Boolean>()
/*     */         {
...
/* 176 */               if (ChannelHandlerMask.logger.isDebugEnabled()) {
/* 177 */                 ChannelHandlerMask.logger.debug("Class {} missing method {}, assume we can not skip execution", new Object[] { this.val$handlerType, this.val$methodName, e });
/*     */               }
/*     */               
/* 180 */               return Boolean.valueOf(false);
/*     */             } 
/* 182 */             return Boolean.valueOf((m != null && m.isAnnotationPresent((Class)ChannelHandlerMask.Skip.class)));
/*     */           }
/*     */         })).booleanValue();
/*     */   }
/*     */   
