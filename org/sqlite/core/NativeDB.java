...
/* 484 */     throw new SQLException(msg);
/*     */   }
/*     */   
...
/*     */     }
/*     */     try {
/* 492 */       return str.getBytes("UTF-8");
/*     */     }
/* 494 */     catch (UnsupportedEncodingException e) {
/* 495 */       throw new RuntimeException("UTF-8 is not supported", e);
/*     */     } 
/*     */   }
/*     */   
/*     */   static String utf8ByteArrayToString(byte[] utf8bytes) {
/* 500 */     if (utf8bytes == null) {
/* 501 */       return null;
/*     */     }
/*     */     try {
/* 504 */       return new String(utf8bytes, "UTF-8");
/*     */     }
/* 506 */     catch (UnsupportedEncodingException e) {
/* 507 */       throw new RuntimeException("UTF-8 is not supported", e);
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\sqlite\core\NativeDB.class
