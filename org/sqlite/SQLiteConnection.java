...
/* 426 */     this.db.addUpdateListener(listener);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 435 */     this.db.removeUpdateListener(listener);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     this.db.addCommitListener(listener);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 454 */     this.db.removeCommitListener(listener);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 468 */     int parameterDelimiter = filename.indexOf('?');
/* 469 */     if (parameterDelimiter == -1)
/*     */     {
/* 471 */       return filename;
/*     */     }
/*     */     
/* 474 */     StringBuilder sb = new StringBuilder();
/* 475 */     sb.append(filename.substring(0, parameterDelimiter));
/*     */     
/* 477 */     int nonPragmaCount = 0;
/* 478 */     String[] parameters = filename.substring(parameterDelimiter + 1).split("&");
/* 479 */     for (int i = 0; i < parameters.length; i++) {
/*     */       
/* 481 */       String parameter = parameters[parameters.length - 1 - i].trim();
/*     */       
...
/*     */ 
/*     */         
/* 488 */         String[] kvp = parameter.split("=");
/* 489 */         String key = kvp[0].trim().toLowerCase();
/* 490 */         if (SQLiteConfig.pragmaSet.contains(key)) {
/* 491 */           if (kvp.length == 1) {
/* 492 */             throw new SQLException(String.format("Please specify a value for PRAGMA %s in URL %s", new Object[] { key, url }));
/*     */           }
/* 494 */           String value = kvp[1].trim();
/* 495 */           if (!value.isEmpty() && 
/* 496 */             !prop.containsKey(key))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */             
/* 506 */             prop.setProperty(key, value);
/*     */           }
/*     */         }
/*     */         else {
/*     */           
/* 511 */           sb.append((nonPragmaCount == 0) ? 63 : 38);
/* 512 */           sb.append(parameter);
/* 513 */           nonPragmaCount++;
/*     */         } 
/*     */       } 
/*     */     } 
/* 517 */     String newFilename = sb.toString();
/* 518 */     return newFilename;
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\sqlite\SQLiteConnection.class
