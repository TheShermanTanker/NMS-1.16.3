...
/*  44 */     final NonBlockingInputStream nbis = NonBlocking.nonBlocking(getName(), in);
...
/*     */     
/*  79 */     this.output = out;
/*  80 */     this.reader = NonBlocking.nonBlocking(getName(), (InputStream)this.input, encoding());
/*  81 */     this.writer = new PrintWriter(new OutputStreamWriter(this.output, encoding()));
/*  82 */     this.attributes = new Attributes();
/*  83 */     this.attributes.setControlChar(Attributes.ControlChar.VERASE, 127);
/*  84 */     this.attributes.setControlChar(Attributes.ControlChar.VWERASE, 23);
/*  85 */     this.attributes.setControlChar(Attributes.ControlChar.VKILL, 21);
/*  86 */     this.attributes.setControlChar(Attributes.ControlChar.VLNEXT, 22);
...
/* 101 */     return (InputStream)this.input;
/*     */   }
/*     */ 
/*     */   
...
/* 111 */     attr.copy(this.attributes);
/* 112 */     return attr;
/*     */   }
/*     */   
/*     */   public void setAttributes(Attributes attr) {
/* 116 */     this.attributes.copy(attr);
/*     */   }
/*     */   
/*     */   public Size getSize() {
/* 120 */     Size sz = new Size();
/* 121 */     sz.copy(this.size);
/* 122 */     return sz;
/*     */   }
/*     */   
/*     */   public void setSize(Size sz) {
/* 126 */     this.size.copy(sz);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\jline\terminal\impl\DumbTerminal.class
