...
/*     */     }
/*     */     
/*  61 */     return 1 + ((ucs >= 4352 && (ucs <= 4447 || ucs == 9001 || ucs == 9002 || (ucs >= 11904 && ucs <= 42191 && ucs != 12351) || (ucs >= 44032 && ucs <= 55203) || (ucs >= 63744 && ucs <= 64255) || (ucs >= 65040 && ucs <= 65049) || (ucs >= 65072 && ucs <= 65135) || (ucs >= 65280 && ucs <= 65376) || (ucs >= 65504 && ucs <= 65510) || (ucs >= 131072 && ucs <= 196605) || (ucs >= 196608 && ucs <= 262141))) ? 1 : 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 146 */       return false; 
/* 147 */     while (max >= min) {
/* 148 */       int mid = (min + max) / 2;
/* 149 */       if (ucs > (table[mid]).last) {
/* 150 */         min = mid + 1; continue;
/* 151 */       }  if (ucs < (table[mid]).first) {
/* 152 */         max = mid - 1; continue;
/*     */       } 
/* 154 */       return true;
/*     */     } 
/*     */     
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\jlin\\utils\WCWidth.class
