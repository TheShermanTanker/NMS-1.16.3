...
/*     */   implements Parser
/*     */ {
/* 118 */   private static final Map<String, String> DEFAULT_TAGS = new HashMap<>();
/*     */   static {
...
/* 132 */     this((Scanner)new ScannerImpl(reader));
/*     */   }
/*     */   
/*     */   public ParserImpl(Scanner scanner) {
/* 136 */     this.scanner = scanner;
/* 137 */     this.currentEvent = null;
/* 138 */     this.directives = new VersionTagsTuple(null, new HashMap<>(DEFAULT_TAGS));
/* 139 */     this.states = new ArrayStack(100);
/* 140 */     this.marks = new ArrayStack(10);
/* 141 */     this.state = new ParseStreamStart();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 148 */     peekEvent();
/* 149 */     return (this.currentEvent != null && this.currentEvent.is(choice));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 225 */           throw new ParserException(null, null, "expected '<document start>', but found '" + ParserImpl.this.scanner
/* 226 */               .peekToken().getTokenId() + "'", ParserImpl.this.scanner.peekToken().getStartMark());
/*     */         }
/* 228 */         token = ParserImpl.this.scanner.getToken();
/* 229 */         Mark endMark = token.getEndMark();
/*     */         
/* 231 */         DocumentStartEvent documentStartEvent = new DocumentStartEvent(startMark, endMark, true, tuple.getVersion(), tuple.getTags());
...
/* 293 */           throw new ParserException(null, null, "found duplicate YAML directive", token
/* 294 */               .getStartMark());
/*     */         }
/* 296 */         List<Integer> value = token.getValue();
/* 297 */         Integer major = value.get(0);
/* 298 */         if (major.intValue() != 1) {
/* 299 */           throw new ParserException(null, null, "found incompatible YAML document (version 1.* is required)", token
/*     */               
/* 301 */               .getStartMark());
/*     */         }
...
/* 318 */           throw new ParserException(null, null, "duplicate tag handle " + handle, token
/* 319 */               .getStartMark());
/*     */         }
...
/* 428 */         SequenceStartEvent sequenceStartEvent = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark, DumperOptions.FlowStyle.BLOCK);
/*     */         
...
/*     */         } 
/*     */         
/* 444 */         scalarEvent = new ScalarEvent(anchor, tag, implicitValues, token.getValue(), startMark, endMark, token.getStyle());
...
/* 448 */         SequenceStartEvent sequenceStartEvent = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark, DumperOptions.FlowStyle.FLOW);
/*     */         
...
/* 453 */         MappingStartEvent mappingStartEvent = new MappingStartEvent(anchor, tag, implicit, startMark, endMark, DumperOptions.FlowStyle.FLOW);
/*     */         
...
/* 458 */         SequenceStartEvent sequenceStartEvent = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark, DumperOptions.FlowStyle.BLOCK);
/*     */         
...
/* 463 */         MappingStartEvent mappingStartEvent = new MappingStartEvent(anchor, tag, implicit, startMark, endMark, DumperOptions.FlowStyle.BLOCK);
/*     */         
/* 465 */         this.state = new ParseBlockMappingFirstKey();
/* 466 */       } else if (anchor != null || tag != null) {
/*     */ 
/*     */         
/* 469 */         scalarEvent = new ScalarEvent(anchor, tag, new ImplicitTuple(implicit, false), "", startMark, endMark, DumperOptions.ScalarStyle.PLAIN);
/*     */         
...
/* 480 */         throw new ParserException("while parsing a " + node + " node", startMark, "expected the node content, but found '" + token
/* 481 */             .getTokenId() + "'", token
/* 482 */             .getStartMark());
/*     */       } 
/*     */     } 
/*     */     
...
/* 514 */         throw new ParserException("while parsing a block collection", (Mark)ParserImpl.this.marks.pop(), "expected <block end>, but found '" + token1
/* 515 */             .getTokenId() + "'", token1
/* 516 */             .getStartMark());
/*     */       } 
...
/* 570 */         throw new ParserException("while parsing a block mapping", (Mark)ParserImpl.this.marks.pop(), "expected <block end>, but found '" + token1
/* 571 */             .getTokenId() + "'", token1
/* 572 */             .getStartMark());
/*     */       } 
...
/* 635 */             throw new ParserException("while parsing a flow sequence", (Mark)ParserImpl.this.marks.pop(), "expected ',' or ']', but got " + token1
/* 636 */                 .getTokenId(), token1
/* 637 */                 .getStartMark());
/*     */           } 
/*     */         }
...
/*     */           
/* 643 */           MappingStartEvent mappingStartEvent = new MappingStartEvent(null, null, true, token1.getStartMark(), token1.getEndMark(), DumperOptions.FlowStyle.FLOW);
...
/* 730 */             throw new ParserException("while parsing a flow mapping", (Mark)ParserImpl.this.marks.pop(), "expected ',' or '}', but got " + token1
/* 731 */                 .getTokenId(), token1
/* 732 */                 .getStartMark());
/*     */           } 
/*     */         }
...
/* 793 */     return (Event)new ScalarEvent(null, null, new ImplicitTuple(true, false), "", mark, mark, DumperOptions.ScalarStyle.PLAIN);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\yaml\snakeyaml\parser\ParserImpl.class
