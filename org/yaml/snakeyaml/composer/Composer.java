...
/* 125 */       throw new ComposerException("expected a single document in the stream", contextMark, "but found another document", event
/* 126 */           .getStartMark());
/*     */     } 
/*     */     
...
/* 140 */         throw new ComposerException(null, null, "found undefined alias " + anchor, event
/* 141 */             .getStartMark());
/*     */       }
...
/* 175 */       nodeTag = this.resolver.resolve(NodeId.scalar, ev.getValue(), ev
/* 176 */           .getImplicit().canOmitTagInPlainScalar());
/* 177 */       resolved = true;
/*     */     } else {
/* 179 */       nodeTag = new Tag(tag);
/*     */     } 
/*     */     
/* 182 */     ScalarNode scalarNode = new ScalarNode(nodeTag, resolved, ev.getValue(), ev.getStartMark(), ev.getEndMark(), ev.getScalarStyle());
/* 183 */     if (anchor != null) {
...
/*     */     
/* 203 */     SequenceNode node = new SequenceNode(nodeTag, resolved, children, startEvent.getStartMark(), null, startEvent.getFlowStyle());
/* 204 */     if (anchor != null) {
...
/*     */     
/* 230 */     MappingNode node = new MappingNode(nodeTag, resolved, children, startEvent.getStartMark(), null, startEvent.getFlowStyle());
/* 231 */     if (anchor != null) {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\yaml\snakeyaml\composer\Composer.class
