...
/* 133 */     HashMap<StatsInterface, ArrayList<NativeFunction>> rc = new HashMap<>(this.snapshot.size() * 2);
/* 134 */     for (Map.Entry<StatsInterface, ArrayList<NativeFunction>> entry : this.snapshot.entrySet()) {
/* 135 */       ArrayList<NativeFunction> list = new ArrayList<>(((ArrayList)entry.getValue()).size());
...
/* 145 */     HashMap<StatsInterface, ArrayList<NativeFunction>> rc = new HashMap<>(this.snapshot.size() * 2);
/* 146 */     for (Map.Entry<StatsInterface, ArrayList<NativeFunction>> entry : this.snapshot.entrySet()) {
/* 147 */       StatsInterface si = entry.getKey();
/* 148 */       ArrayList<NativeFunction> list = new ArrayList<>(((ArrayList)entry.getValue()).size());
...
/* 205 */     HashMap<StatsInterface, ArrayList<NativeFunction>> rc = new HashMap<>();
/* 206 */     for (StatsInterface sc : classes) {
/* 207 */       int count = sc.functionCount();
/* 208 */       ArrayList<NativeFunction> functions = new ArrayList<>(count);
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\fusesource\hawtjni\runtime\NativeStats.class
