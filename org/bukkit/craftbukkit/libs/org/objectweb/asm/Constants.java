...
/* 194 */     if (!internalName.startsWith("org/bukkit/craftbukkit/libs/org/objectweb/asm/")) {
/* 195 */       return false;
/*     */     }
/* 197 */     String member = "(Annotation|Class|Field|Method|Module|RecordComponent|Signature)";
/* 198 */     return (internalName.contains("Test$") || 
/* 199 */       Pattern.matches("org/bukkit/craftbukkit/libs/org/objectweb/asm/util/Trace" + member + "Visitor(\\$.*)?", internalName) || 
/*     */       
/* 201 */       Pattern.matches("org/bukkit/craftbukkit/libs/org/objectweb/asm/util/Check" + member + "Adapter(\\$.*)?", internalName));
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 210 */     try { DataInputStream callerClassStream = new DataInputStream(classInputStream); Throwable throwable = null; 
/* 211 */       try { callerClassStream.readInt();
/* 212 */         minorVersion = callerClassStream.readUnsignedShort(); } catch (Throwable throwable1) { throwable = throwable1 = null; throw throwable1; }
/* 213 */       finally { if (callerClassStream != null) if (throwable != null) { try { callerClassStream.close(); } catch (Throwable throwable1) {} } else { callerClassStream.close(); }   }  } catch (IOException ioe)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\bukkit\craftbukkit\libs\org\objectweb\asm\Constants.class
