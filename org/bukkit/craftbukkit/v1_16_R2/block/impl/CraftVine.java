...
/*    */ import net.minecraft.server.v1_16_R2.BlockVine;
...
/* 19 */       getBoolean(BlockVine.class, "north", true), getBoolean(BlockVine.class, "east", true), getBoolean(BlockVine.class, "south", true), getBoolean(BlockVine.class, "west", true), getBoolean(BlockVine.class, "up", true), getBoolean(BlockVine.class, "down", true)
/*    */     };
/*    */ 
/*    */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\org\bukkit\craftbukkit\v1_16_R2\block\impl\CraftVine.class
