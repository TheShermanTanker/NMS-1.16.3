...
/*     */     
/*  67 */     return (ResultSetInternalMethods)Proxy.newProxyInstance(originalResultSet.getClass().getClassLoader(), new Class[] { ResultSetInternalMethods.class }, new InvocationHandler()
/*     */         {
/*     */           
/*     */           public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
/*     */           {
/*  72 */             if ("equals".equals(method.getName()))
/*     */             {
/*  74 */               return Boolean.valueOf(args[0].equals(this));
/*     */             }
/*     */             
/*  77 */             Object invocationResult = method.invoke(finalResultSet, args);
/*     */             
/*  79 */             String methodName = method.getName();
/*     */             
/*  81 */             if ((invocationResult != null && invocationResult instanceof String) || "getString".equals(methodName) || "getObject".equals(methodName) || "getObjectStoredProc".equals(methodName)) {
/*     */               
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\com\mysql\jdbc\interceptors\ResultSetScannerInterceptor.class
