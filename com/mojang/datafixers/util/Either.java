...
/*     */   }
/*     */   
/*     */   private static final class Left<L, R> extends Either<L, R> { private final L value;
...
/*  54 */       return (this.valueOptional == null) ? (this.valueOptional = Optional.of(this.value)) : this.valueOptional;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Optional<R> right() {
/* 120 */       return (this.valueOptional == null) ? (this.valueOptional = Optional.of(this.value)) : this.valueOptional;
/*     */     }
/*     */ 
/*     */     
/*     */     public String toString() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\tuinity-1.16.3.jar!\com\mojang\datafixer\\util\Either.class
